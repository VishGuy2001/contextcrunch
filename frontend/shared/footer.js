  ...
  <div style="max-width:1060px;margin:0 auto">
    <div style="display:grid;grid-template-columns:280px 1fr;gap:4rem;margin-bottom:3rem">
      <div>
        ...
        <p style="font-size:.88rem;color:#888;line-height:1.65;margin-bottom:.75rem">Crunch your AI context.<br>Stop losing work. Stop wasting tokens.</p>
      ...
      <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:2rem">
        ...
        <div style="display:flex;flex-direction:column;gap:.6rem">
          ...
          <a href="https://pypi.org/project/contextcrunch" target="_blank" style="font-size:.85rem;color:#aaa">PyPI</a>
          <a href="${depth}math/README.md" style="font-size:.85rem;color:#aaa">Math paper</a>
        </div>
        <div style="display:flex;flex-direction:column;gap:.6rem">
    ...
    <div style="border-top:1px solid #222;padding-top:1.5rem;display:flex;justify-content:space-between;flex-wrap:wrap;gap:.75rem">
      <span style="font-size:.72rem;color:#555;font-family:var(--mono)">Free · Open source · No data stored · Text only in v0.1 · Documents &amp; images coming soon</span>
